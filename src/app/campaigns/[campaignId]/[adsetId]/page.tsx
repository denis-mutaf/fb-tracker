          ...
          <>
            ...
            <div className="glass-card rounded-xl overflow-hidden">
              ...
              {adsLoading ? (
                ...
                <div className="divide-y divide-white/5">
                  {ads.map((ad) => (
                    <AdRow key={ad.id} ad={ad} onPreview={() => openPreview(ad.id)} />
                  ))}
                </div>
              )}
            </div>
...
function AdRow({ ad, onPreview }: { ad: AdWithMetrics; onPreview: () => void }) {
  ...
  return (
    <div className="flex items-center gap-4 px-4 py-3 min-h-[72px] transition-colors duration-150 hover:bg-white/[0.03]">
